...
function inicializarEventos()
{
  ...
  var alta=document.getElementById('altanoticia');
...
function retornarDatos()
{
  ...
  cad='titulo='+encodeURIComponent(tit)+'&noticia='+encodeURIComponent(not)+'&ciudad='+encodeURIComponent(ciu)+'&accion='+encodeURIComponent(acc)+'&id_noticia='+encodeURIComponent(idn);
