...
<head>
	...
	<script type="text/javascript">
		 ...
		 $(document).ready(function() {
		 	...
		 	document.getElementById("calculartri").addEventListener("click", TipoArea);
		 ...
		 function TipoArea() {
		 	...
		 	if (valor == "Calcular Triangulo"){
		 		CalcularArea('T');
		 	} else if (valor == "Calcular Rectangulo"){
		 		CalcularArea('R');
		 	} else 	{
				CalcularArea('A');
		 	}
...
<body>
	<form id="form_id" action>
		...
		<div>
			<input type="button" id ="volumen" value="Calcular Volumen">
		</div>	
	</form>
