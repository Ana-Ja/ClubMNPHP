                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="active"><a href="user-public-users.php">Friends</a>
                            </li>
            ...
            <div class="timeline-block">
                ...
                <div class="panel panel-default user-box">
                    <div class="panel-body">
                        <div class="media">
                         <img src="images/people/50/<?php echo $amigo->idAmigo->foto ?>" alt="people" class="media-object img-circle pull-left" />
                            <div class="media-body">
                                <a href="" class="username"><?php echo$amigo->idAmigo->nombre ?></a>
