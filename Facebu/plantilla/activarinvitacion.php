...
<?php	
	...
	//obtengo la referencia del usaurio con ese correo
		$contactoSelect = "Select token, fechaAceptacion from contactos where 
		idAmigo = ".$idAmigo." AND idSolicitante=".$idSolicitante;
		echo $contactoSelect;
		...
		if ($resultado->num_rows == 1){
			...
			if ($token==$tokenUsuario && is_null($contacto["fechaSolicitud"])){
