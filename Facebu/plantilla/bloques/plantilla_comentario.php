            ...
            <li>
                <div class="media">
                    <a href="" class="pull-left">
                        <img src="images/people/50/<?php echo $comentario->idpublicacion->autor->foto; ?>" class="media-object">
                    </a>
                    <div class="media-body">
                        <a href="" class="comment-author"><?php echo $comentario->idpublicacion->autor->nombre ;?></a>
                        <span><?php echo $comentario->texto ;?></span>
                        <div class="comment-date"><?php echo cambiaf_a_normal($comentario->fecha); ?></div>
                    </div>
                </div>
            </li>
<!--             <li>
